...
"selection"in D&&"createRange"in D.selection?D.selection.createRange().text=t:(n=e.selectionStart,"textarea"===e.type&&e.scrollTop&&(r=e.scrollTop,o=e.scrollLeft),t=u(e,t),e.value=e.value.slice(0,e.selectionStart)+t+e.value.slice(e.selectionEnd),r&&(e.scrollTop=r,e.scrollLeft=o),a=n+t.length,e.setSelectionRange(a,a))}function h(e,t,n){"addEventListener"in e?(e.removeEventListener(t,n,!1),e.addEventListener(t,n,!1)):(e.detachEvent("on"+t,n),e.attachEvent("on"+t,n))}function f(e,t,n){"removeEventListener"in e?e.removeEventListener(t,n,!1):e.detachEvent("on"+t,n)}function v(e,t){function n(){f(e,"touchmove",a),f(e,"touchend",r),i=null,l=null,c=null,u=null}function a(e){var t
e.touches.length>1?n():(c=e.touches[0].pageX-i,t=e.touches[0].pageY-l,u&&0>u&&c>0||u>0&&0>c||Math.abs(t)>v?n():(u=c,e.preventDefault()))}function r(){var a=Math.abs(c)
n(),a>s&&t({target:e,direction:c>0?"RIGHT":"LEFT"})}function o(t){1===t.touches.length&&(i=t.touches[0].pageX,l=t.touches[0].pageY,h(e,"touchmove",a),h(e,"touchend",r))}var i,l,c,u,s=50,v=15
h(e,"touchstart",o)}function d(e){var t="which"in e?e.which:e.keyCode,n=String.fromCharCode(t).toUpperCase(),a=e.ctrlKey||e.metaKey
a&&n in T&&(T[n](e),"preventDefault"in e?(e.preventDefault(),e.stopPropagation()):(e.returnValue=!1,e.cancelBubble=!0))}function g(e){var t="target"in e?e.target:e.srcElement,n="which"in e?e.which:e.keyCode,a=String.fromCharCode(n),r=/^[A-Za-z]{1}$/.test(a),o=e.ctrlKey||e.metaKey,i=!1
...
if(t=p(),e.all)for(r=0;r<t.length;r++)n=t[r],a(e.blacklist,n.name)<0&&(h(n,"keydown",d),h(n,"keypress",g),v(n,o),x[n.name]="ug")
else for(r=0;r<t.length;r++)n=t[r],a(e.whitelist,n.name)>=0&&(h(n,"keydown",d),h(n,"keypress",g),v(n,o),x[n.name]="ug")}function y(){var e,t,n
for(e=p(),n=0;n<e.length;n++)t=e[n],f(t,"keydown",d),f(t,"keypress",g)}function b(e){var t=":",n=e.whitelist||"",a=e.blacklist||"",r={}

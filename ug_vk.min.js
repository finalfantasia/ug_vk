/*
    ug_vk.min.js (https://github.com/finalfantasia/ug_vk)
    The MIT License (MIT)
...
if(T?K.length&&(o=!1,K=K.split(k)):(D.length&&(o=!1,D=D.split(k)),K.length&&(o=!1,T=!0,K=K.split(k))),!o)if(e=v(),T)for(a=0;a<e.length;a++)n=e[a],t(K,n.name)<0&&(f(n,"keydown",s),f(n,"keypress",d),u(n,r),S[n.name]=0)

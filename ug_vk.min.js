...
d(t,"touchstart",r)}function v(t){var e="which"in t?t.which:t.keyCode,n=String.fromCharCode(e).toUpperCase(),a=t.ctrlKey||t.metaKey
a&&n in S&&(S[n](t),"preventDefault"in t?(t.preventDefault(),t.stopPropagation()):(t.returnValue=!1,t.cancelBubble=!0))}function g(t){var e="target"in t?t.target:t.srcElement,n="which"in t?t.which:t.keyCode,a=String.fromCharCode(n),i=/^[A-Za-z]{1}$/.test(a),r=t.ctrlKey||t.metaKey,o=!1
r||"ug"!==M[e.name]||(a in L?("keyCode"in t&&!("which"in t)?t.keyCode=L[a].charCodeAt(0):s(e,L[a]),o=!0):i&&(t.returnValue=!1,o=!0)),o&&("preventDefault"in t?(t.preventDefault(),t.stopPropagation()):t.cancelBubble=!0)}function m(){var t,e,n,a=[]
